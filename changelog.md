...
## feat
- 半自动化测试
- 支持masa gadget的快速配置gui切换

# 1.0.10
## feat
- 现在若版本过时, 会在提示消息内附上下载链接
- 加入弓箭助手 (别在服务器上乱用)
- 加入nashorn禁用功能, 现在它不是默认启动的
- 对js脚本的逻辑进行了修改, 加入了一些方法帮助你平推私有方法/字段
同时现在默认给出的实体不是经过代理的实体, 需要你自己反混淆

## fix
- 修复了config加载过慢的问题
- 修复了var shower在跨维度时会丢失的问题
